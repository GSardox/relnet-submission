    ...
    try:
        ...
        for model_seed in model_seeds:
            ...
            if agent.is_deterministic and model_seed > 0:
                logger.info(f"breaking out of evaluation loop as agent {agent.algorithm_name} is deterministic.")
            ...
            try:
                ...
                result_row['cummulative_reward'] = agent_instance.eval(test_g_list)
